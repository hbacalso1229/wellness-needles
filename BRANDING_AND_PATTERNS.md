...
- Post-submit: **thank-you** page on success; **unable-to-process** apologetic page (call / email / try again) on send failure — never a red technical error toast
...
- [ ] Booking submit success → thank-you page; send/config failure → unable-to-process (apologetic call/email) — no technical error toast
