...
export function BookingSection() {
  return (
    <section
      className="relative py-20 overflow-hidden bg-jungle-gradient text-cream"
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col items-center gap-1.5 mb-5" aria-hidden="true">
          <PulsingLeaf size="small" color="text-gold/80" />
          <div className="h-0.5 w-14 rounded-full bg-gold" />
        </div>
        <p className="text-lg text-cream/90 mb-10 max-w-xl mx-auto leading-relaxed">
          Take a quiet next step. Book a session and begin restoring balance at a pace that
          feels right for you.
        </p>
        <div data-hide-sticky-book className="inline-flex justify-center">
