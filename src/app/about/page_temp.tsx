import { Heart, Award, Target, Clock, Shield, Leaf } from 'lucide-react'
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="font-serif text-5xl md:text-6xl font-bold text-primary mb-6">
              About Wellness Needles
            </h1>
            <p className="text-xl text-secondary mb-8">
              Dedicated to bringing you the finest in traditional Chinese medicine and acupuncture therapy
            </p>
            <p className="text-lg text-secondary/80">
              Our practice combines ancient healing wisdom with modern understanding to provide 
              ...
              <div className="space-y-6">
                ...
                <div className="mt-6">
                  <div className="relative group">
                    ...
                    <div className="relative h-64 rounded-xl overflow-hidden shadow-xl bg-cream/50 p-2">
                      ...
                      <div className="absolute -top-1 -right-1 text-primary/60 group-hover:text-primary animate-pulse">
                        <Leaf className="w-3 h-3 transform rotate-12" />
                      </div>
                      <div className="absolute -bottom-1 -left-1 text-accent/60 group-hover:text-accent animate-pulse" style={{ animationDelay: '0.7s' }}>
                        <Leaf className="w-2 h-2 transform -rotate-45" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-cream rounded-xl p-8 text-center shadow-lg relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="relative group mb-6">
                  ...
                  {/* Floating leaf decorations */}
                  <div className="absolute -top-2 -right-2 text-gold/60 animate-pulse">
                    <Leaf className="w-4 h-4 transform rotate-45" />
                  </div>
                  <div className="absolute -bottom-2 -left-2 text-accent/60 animate-pulse" style={{ animationDelay: '1s' }}>
                    <Leaf className="w-3 h-3 transform -rotate-12" />
                  </div>
                </div>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-primary mb-2">Certified Expert</h3>
              <p className="text-secondary text-sm">
                Arkinth Garcia is licensed and certified in acupuncture and naturopathic medicine from Dublin&apos;s prestigious College of Naturopathic Medicine
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-primary mb-2">Flexible Scheduling</h3>
              <p className="text-secondary text-sm">
                We offer convenient appointment times to fit your busy lifestyle and schedule
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-primary mb-2">Personal Experience</h3>
              <p className="text-secondary text-sm">
                Having experienced the healing power of acupuncture firsthand, Arkinth brings both professional expertise and personal understanding to your care
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-primary text-cream relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link
            href="/bookings"
            className="bg-gold text-primary px-8 py-4 rounded-full text-lg font-semibold hover:bg-gold/90 transition-all duration-300"
          >
