...
|-------|-------|---------|-----|---------|
| Confirm, still before 09:00 Dublin the calendar day before | Card + calendar invite (`waitUntil` clinic copy to `info@`) | Appointment confirmed | Same, only if Patient SMS is on **and** the patient opted in | `Wellness Needles — appointment confirmed` |
